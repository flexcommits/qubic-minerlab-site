...
export const dataProvider = (
    ...
    return {
        getList: async ({ resource, pagination, filters, sorters, meta }) => {
            ...
            */
            if (meta?.rpc) {                
                const { resource, body } = meta.rpc;
                query = supabaseClient.rpc(resource, body);
                ...
                query = client.from(resource).select(meta?.select ?? "*", {
