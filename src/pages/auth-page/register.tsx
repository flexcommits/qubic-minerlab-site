...
import { layoutStyles, titleStyles } from "@refinedev/mui/src/components/pages/auth/components/styles";
...
export const RegisterPage: React.FC<RegisterProps> = ({
    ...
    const referral_id = queryParams.get('referral');
    const hanleSubmitExtraRef = async (data: RegisterFormTypes) => {
        const dataWithReferral = { ...data, referral_id: referral_id ?? undefined};
        if(onSubmit) {
            return onSubmit(dataWithReferral);
        }
        return registerMutate(dataWithReferral);
        // submit dataWithReferral
    };
                ...
                {!hideForm && (
                    <Box
                        ...
                        onSubmit={handleSubmit((data) => {
                            return hanleSubmitExtraRef(data);
                            // if (onSubmit) {
                    ...
                    >
                        ...
                        <Button
                            ...
                            className="text-white bg-primary font-poppins"
                        >
                ...
                {loginLink ?? (
                    ...
                    >
                        ...
                        <MuiLink
                            ...
                            fontSize="12px"
                            fontWeight="bold"
                            className="font-poppins primary"
                        >
